...
Thanks for your interest in contributing to a Colmado-Inc project.
...
**Don't open a public issue.** See [SECURITY.md](./SECURITY.md) and email security@colmado.click.
